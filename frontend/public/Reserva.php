    ...
    <footer id="footer" class="s-footer">
        <div class="row s-footer__main-content">
            <div class="column xl-6 md-12 s-footer__block s-footer__about">
                <div class="s-footer__logo animate-scale-in">
                    <a class="logo" href="Index.html">
                        <img src="assets/imagenes/LOGO/LOGO.jpg" alt="Página de inicio">
                    </a>
                </div>

                <p class="animate-fade-in-left">La Casona es el lugar perfecto para disfrutar de platos deliciosos en un ambiente acogedor. Te esperamos con la mejor atención y sabores únicos.</p>
            </div>

            <div class="column xl-6 md-12 s-footer__block s-footer__info">
                <div class="row">
                    <div class="column xl-6 lg-12">
                        <h5 class="animate-fade-in-right">Ubicación</h5>
                        <p class="animate-fade-in-right">
                        Antigua panamericana, <br>
                        Club Kawai Unión Biblíca del Perú - km 88.8
                        </p>
                    </div>
                    <div class="column xl-6 lg-12">
                        <h5 class="animate-fade-in-right">Contactos</h5>
                        <ul class="link-list animate-fade-in-right">
                            <li><a href="casonaKawai@gmail.com">casonaKawai@gmail.com</a></li>
                            <li><a href="tel:+51980436234">+51 980 436 234</a></li>
                        </ul>
                    </div>
                    <div class="column">
                        <h5 class="animate-fade-in">Horarios de Atención</h5>
        ...
        <div class="row s-footer__bottom">
            <div class="column xl-6 lg-12">
                <ul class="s-footer__social social-list animate-scale-in">
                    <li>
                ...
                <div class="column xl-6 lg-12">
                    <p class="ss-copyright animate-fade-in">
                        <span>© Copyright Kawaii 2025</span>
                        <a href="admin/Login.php" style="margin-left: 15px; color: #ff9800; text-decoration: underline;">
            ...
            <div class="ss-go-top animate-scale-in">
